...
The main goal of this architecture is to isolate as much as possible the domain model. Technically the model is isolated from the outside world by the so called **ports** and **adapters**.
